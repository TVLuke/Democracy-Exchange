# Stimmen der Wahl zum Deutschen Bundestag 2021 nach Österreichischem Wahlrecht.
Year: 2021
...
## Visualizations
### Parliament Seating
![Parliament seating arrangement with 598 total seats. Parties from left to right: DIE LINKE with 32 seats (5.4%), GRÜNE with 96 seats (16.1%), SPD with 169 seats (28.3%), CDU/CSU with 158 seats (26.4%), FDP with 75 seats (12.5%), AfD with 68 seats (11.4%). Hinweis: Verteilung nutzt nur Listenstimmen (Zweitstimmen).](../plots/germany2021_austria_parliament.png)

### Coalition Possibilities
![Possible coalition combinations that form a majority, sorted by ideological distance (smaller distance means parties are closer on the left-right spectrum): SPD + CDU/CSU with 327 seats (54.7%, ideological distance: 2.0); CDU/CSU + FDP + AfD with 301 seats (50.3%, ideological distance: 4.0); SPD + FDP + AfD with 312 seats (52.2%, ideological distance: 8.0); GRÜNE + SPD + FDP with 340 seats (56.9%, ideological distance: 10.0); GRÜNE + CDU/CSU + FDP with 329 seats (55.0%, ideological distance: 10.0); GRÜNE + SPD + AfD with 333 seats (55.7%, ideological distance: 12.0); GRÜNE + CDU/CSU + AfD with 322 seats (53.8%, ideological distance: 12.0); DIE LINKE + CDU/CSU + FDP + AfD with 333 seats (55.7%, ideological distance: 22.0). Die "Ideologische Distanz": Für die Darstellung in korrekter Reihenfolge hat jede Partei einen left_to_right-Wert, mit 1 für die Partei, welche üblicherweise im Parlament ganz links sitzt, dann aufsteigend: Dieser Wert wird hier auch einfach als Distanzwert gewertet, um wahrscheinliche Koalitionen darzustellen. Diese Berechnung ist natürlich stark vereinfachend und in vielen Fällen einfach falsch.  Beispiel für die Koalition CDU/CSU-FDP-AfD: CDU/CSU: left_to_right = 6 FDP: left_to_right = 7 AfD: left_to_right = 8 Ideologische Distanz = |6-7| + |6-8| + |7-8| = 4](../plots/germany2021_austria_coalitions.png)

### Vote vs Seat Distribution
![Bar chart comparing each party's vote percentage (darker bars) with their seat percentage (lighter bars). Parties with significant differences: SPD (25.7% votes vs 28.3% seats, Δ2.6%), CDU/CSU (24.1% votes vs 26.4% seats, Δ2.3%), GRÜNE (14.7% votes vs 16.1% seats, Δ1.3%), FDP (11.4% votes vs 12.5% seats, Δ1.1%), FREIE WÄHLER (2.4% votes vs 0.0% seats, Δ2.4%), Tierschutzpartei (1.5% votes vs 0.0% seats, Δ1.5%), dieBasis (1.4% votes vs 0.0% seats, Δ1.4%). Total vote-seat difference: 17.5%. (Listenstimmen)](../plots/germany2021_austria_vote_seat_distribution.png)
...
|-------|--------|------------|-------|------------|-------------------|
| SPD | 11,901,558 | 25.71% | 169 | 28.26% | 2.55% |
